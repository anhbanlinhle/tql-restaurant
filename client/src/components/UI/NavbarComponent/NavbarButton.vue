...
<template>
    ...
    >
        <div 
            @click="moveTo"
            class="relative cursor-pointer flex items-center before:z-[-1] after:z[-1] group-hover:before:content-[''] group-hover:before:absolute group-hover:before:right-1/2 group-hover:before:w-[64px] group-hover:before:h-[64px] group-hover:before:-top-[64px] group-hover:before:rounded-full group-hover:before:shadow-[45px_36px_0_10px] group-hover:before:shadow-[#f5f7fb] group-hover:before:bg-transparent group-hover:after:content-[''] group-hover:after:absolute group-hover:after:right-1/2 group-hover:after:w-[64px] group-hover:after:h-[64px] group-hover:after:-bottom-[64px] group-hover:after:rounded-full group-hover:after:shadow-[45px_-36px_0_10px] group-hover:after:shadow-[#f5f7fb] group-hover:after:bg-transparent"
            :class="routeMatched ? 'before:absolute before:right-1/2 before:w-[64px] before:h-[64px] before:-top-[64px] before:rounded-full before:shadow-[45px_36px_0_10px] before:shadow-[#f5f7fb] before:bg-transparent after:absolute after:right-1/2 after:w-[64px] after:h-[64px] after:-bottom-[64px] after:rounded-full after:shadow-[45px_-36px_0_10px] after:shadow-[#f5f7fb] after:bg-transparent' : ''"
        >

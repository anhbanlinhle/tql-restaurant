...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th7 03, 2023 lúc 06:50 PM
...
--
-- Cơ sở dữ liệu: `tql_restaurant`
--

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `available_mail`
--
...
--
-- Đang đổ dữ liệu cho bảng `available_mail`
--
...
--
-- Cấu trúc bảng cho bảng `cooking`
--
...
--
-- Đang đổ dữ liệu cho bảng `cooking`
--
...
(6, 'Shrimp Cocktail', 'appetizer', 'https://www.foodnetwork.com/recipes/food-network-kitchen/shrimp-cocktail-recipe2-1942120'),
...
(13, 'Beef Stir-Fry', 'main_dish', 'https://www.recipetineats.com/easy-classic-chinese-beef-stir-fry/'),
...
--
-- Cấu trúc bảng cho bảng `pre_order`
--
...
--
-- Chỉ mục cho bảng `available_mail`
--
ALTER TABLE `available_mail`
  ADD PRIMARY KEY (`email`);

--
-- Chỉ mục cho bảng `cooking`
--
ALTER TABLE `cooking`
...
--
-- Các ràng buộc cho bảng `cooking`
--
ALTER TABLE `cooking`
...
--
-- Các ràng buộc cho bảng `pre_order`
--
ALTER TABLE `pre_order`
